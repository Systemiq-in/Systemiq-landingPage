          ...
          {verticals.map((v) => (
            ...
            >
              <div className="space-y-4">
                ...
                <h2 className="text-2xl font-bold text-white tracking-tight">{v.title}</h2>
                ...
                <div className="p-4 rounded-2xl bg-rose-50/60 border border-rose-100 space-y-1">
                  ...
                  <p className="text-xs sm:text-sm text-white leading-relaxed">{v.problem}</p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-blue-50/60 border border-blue-100 space-y-1">
                  ...
                  <p className="text-xs sm:text-sm text-white font-medium leading-relaxed">{v.solution}</p>
                </div>
              </div>
