    ...
    <div className="min-h-screen bg-[#F5F5F7] text-[#1D1D1F] pt-32 pb-20 antialiased">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-sm text-[#86868B]">
          ...
          <h2 className="text-lg font-bold text-[#1D1D1F] mt-8 mb-4">1. Conditions of Use</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-[#1D1D1F] mt-8 mb-4">2. Intellectual Property</h2>
          <p>
