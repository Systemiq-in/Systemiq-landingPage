    ...
    <div className="min-h-screen bg-transparent text-white/90 pt-32 pb-20 antialiased">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-sm text-white/50">
          ...
          <h2 className="text-lg font-bold text-white mt-8 mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-white mt-8 mb-4">2. How We Use Your Information</h2>
          <p>
