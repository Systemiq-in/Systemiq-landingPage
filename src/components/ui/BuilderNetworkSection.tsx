...
export default function BuilderNetworkSection() {
  return (
    <section className="py-24 lg:py-32 bg-[#0A0A0A] border-y border-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.03)_1px,transparent_1px)] [background-size:24px_24px] opacity-40" />
