...
export default function FeaturedIndustries() {
  return (
    <section className="py-16 lg:py-20 bg-white border-t border-black/[0.08]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((ind, idx) => (
            <motion.div
              ...
              className="bg-[#F5F5F7] rounded-3xl p-6 border border-black/[0.06] hover:border-[#0071E3]/40 shadow-sm hover:shadow-md transition-all duration-300 space-y-4 flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 rounded-2xl bg-white flex items-center justify-center mb-4 border border-black/[0.06]">
                  {ind.icon}
                </div>
                <h3 className="text-lg font-bold text-[#1D1D1F] tracking-tight">
                  {ind.title}
                </h3>
                <p className="text-xs sm:text-sm text-[#86868B] leading-relaxed font-normal mt-2">
                  {ind.desc}
                </p>
              </div>
              ...
              <Link
                href="/industries"
                className="text-xs font-semibold text-[#0071E3] hover:underline flex items-center gap-1 pt-3 border-t border-black/[0.06]"
              >
